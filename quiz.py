...
The following commands are available:
    ...
    .schema  - Show the schema used to create all tables
    .schema <table_name> - Show the schema used to create named table
...
class SQLQuiz(object):
    ...
    def get_solution(self):
        ...
        while True:
            ...
            elif command in ["mode", "headers"]:
                print "*** In the real SQLite monitor, this command would work."
                print "*** But this is a just a Python script acting as a quiz."
                print "*** Sorry!"
                sql = ""
